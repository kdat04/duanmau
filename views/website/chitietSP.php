    ...
    <section class="ctsp">
        ...
        <div class="text-nut">
            ...
            <div class="size">
                <h3>Kích thước:</h3>
                <div class="size-t">
                    <button class="size-con">S</button>
                    <button class="size-con">M</button>
                    <button class="size-con">L</button>
                    <button class="size-con">XL</button>
                    <button class="size-con">2XL</button>
                </div>
            </div>
            <!--  -->
